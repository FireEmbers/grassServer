...
function catAspect(ID, cb){
  ...
  var execString = 'cd /home/fsousa/grassdata; cat srtm'+ ID + '_aspect.grass';
...
function catSlope(ID, cb){
  ...
  var execString = 'cd /home/fsousa/grassdata; cat srtm'+ ID + '_slope.grass';
  ...
  function onCat(error, stdout, stderr){
    ...
    if (error !== null) {
      ...
      var rmString = 'cd /home/fsousa/grassdata; \
